...
"""
        ...
        # discovers the broken frontmatter after it has reached main.
        print(f"✗ No concrete generator for publishable task {args.task}; no file written.", file=sys.stderr)
        sys.exit(2)
