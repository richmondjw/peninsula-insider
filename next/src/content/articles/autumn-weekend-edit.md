---
title: "The Autumn Weekend Edit: Why April on the Peninsula Feels Most Earned"
dek: "Cool mornings, warm lunches, empty terraces, and the kind of light that makes every terrace look serious. This is the month the region stops performing and starts meaning something."
author: "editorial"
houseByline: true
...
relatedVenues: ["tedesca-osteria", "montalto", "lindenderry", "ten-minutes-by-tractor"]
...
That is already a complete weekend. Anything else you add will either improve it or ruin it.

## One walk, one market, nothing else

The mistake most first-timers make in April is over-scheduling. You see the weather forecast, you see the empty calendar, you see the drive-time map, and you start adding stops. Don't.

Pick one walk: **Bushrangers Bay** if you want a real coastal descent with the return climb, **Cape Schanck Boardwalk** if you want the drama in forty minutes. Pick one market: **Red Hill** on the first Saturday of the month if it's on, **Mornington** on the second Saturday if you want something quieter and closer to the bay. Do neither if lunch is running long — the mistake is thinking these are mandatory.
...
- Don't try to combine Mornington morning coffee, a winery lunch, a beach walk, and a Sorrento dinner in the same day. You will hate every move by four o'clock. The Peninsula is small enough to drive and too varied to rush.
- Don't book two winery restaurants on the same day. The second one will punish the first one.
