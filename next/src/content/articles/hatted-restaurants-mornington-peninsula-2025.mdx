---
title: "The Hatted Restaurants of the Mornington Peninsula"
dek: "Four two-hat venues, seven one-hat tables, and a debut two-hat restaurant that opened in February. The complete Good Food Guide hat list for the Peninsula, with booking realities and what each restaurant actually is."
author: "editorial"
houseByline: true
publishedAt: 2026-04-22
heroImage:
  src: "/images/sourced/category-restaurant-01.webp"
  alt: "Warm, polished restaurant interior with a marble bar, timber stools, and low lighting - the kind of room that suits a Peninsula hatted-restaurant shortlist"
  credit: "Willian Justen de Vasconcellos / Unsplash"
  license: "tmp-unsplash"
format: "service"
tags: ["hatted-restaurants", "fine-dining", "food-guide", "mornington-peninsula", "winery-dining"]
...
faq:
  - question: "How many hatted restaurants are on the Mornington Peninsula?"
    answer: "The Good Food Guide awarded 15 hats across 11 Peninsula venues, including 4 two-hat restaurants and 7 one-hat restaurants. The Australian Good Food Guide (AGFG) recognises additional venues not in the GFG top list, including Lancemore Lindenderry (AGFG 2 hats) and Paringa Estate (AGFG 1 hat)."
...
|--|--|--|--|
| Barragunda Dining | Cape Schanck | Simone Watts | Degustation only |
| Laura | Merricks (Pt. Leo Estate) | Josep Espuga | $$$$, tasting menus |
| Tedesca Osteria | Red Hill | Brigitte Hafner | Set menu, lunch only |
| Ten Minutes by Tractor | Main Ridge | Craig Lunn | Two tasting formats |
...
|--|--|--|
| Lancemore Lindenderry Dining Room | Red Hill | 2 hats (AGFG) |
| Paringa Estate | Red Hill South | 1 hat (AGFG) |
...
The newest and most talked-about Peninsula restaurant. Opened in February in a converted 40-seat farmhouse on the 1000-acre Barragunda Estate. Chef Simone Watts (ex-Coda, Pearl Melbourne) won the GFG Trailblazer Award alongside the two-hat debut. The format is a degustation, priced in line with the Peninsula's other two-hat rooms, and the focus is on estate-grown organic vegetables, hibachi-charred proteins, and exceptional produce sourcing.
...
One hat. Walk-in only: no reservations taken. The informal outdoor dining counterpart to Doot Doot Doot, built around a wood-fired oven. The Classic Hare Share feast is the anchor format, at mid-range set-menu pricing. Dog-friendly on the outdoor lawn. Walk-ins Monday to Friday from 5pm; Saturday and Sunday from 2pm.
...
One hat. Three to four-course set menu in the main restaurant. The Piazza (walk-in daily 11am–5pm) provides a casual alternative. Lunch Friday to Monday in the main restaurant; 1km sculpture trail on the property.
