...
format: "service"
tags: ["walks", "spa", "cape-schanck", "day-trip", "explore", "itinerary", "all-year"]
...
**Near Cape Schanck (0–5 min from walk start):** Barragunda Dining (two-hat GFG 2025, degustation only). Requires well-advance booking, not a spontaneous lunch option.
