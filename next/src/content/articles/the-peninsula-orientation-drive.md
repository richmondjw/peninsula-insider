...
heroImage:
  src: "/images/placeholder-orientation-drive.jpg"
...
The honest answer is that one day is not enough to see the Peninsula properly, because the region is not one landscape. It is four: the bayside towns along Port Phillip, the winery plateau through the middle, the ocean coast along the south, and the tip that runs from Sorrento to Point Nepean. Most first-time visitors pick one of these, stay in it, and leave wondering what everyone else is talking about.
...
You are not here for the cafe, though. You are here because Mornington is the Peninsula's front door and Commonfolk is the clearest statement the town makes about what it has become: a real place, with serious infrastructure, not a waypoint. Sit for fifteen minutes. Watch the roaster. Then get back in the car.
...
This is the reason the stop exists. Every other lookout on the Peninsula shows you one thing. The Arthurs Seat view shows you almost all of it: Port Phillip to the north, the back beaches to the south-west, the hinterland rolling east toward Western Port, and the wine-growing plateau you are about to drive through. When you come back down forty minutes later, you will already have a mental model of the region that most repeat visitors never build.
...
From the base of Arthurs Seat, head east along Arthurs Seat Road and onto Red Hill Road, and drive the ridge slowly. This is the stretch that made the Peninsula a food and wine region and it is the only part of the drive that you should treat as the experience rather than transport. Vineyard rows on both sides. Cellar door signs every hundred metres. Stone walls, farm gates, the occasional alpaca.

You are not stopping at a cellar door. Resist. The point of this leg is that a single twenty-minute drive from Arthurs Seat to Merricks will explain the entire geographical logic of the Peninsula's wine country — the altitude that makes pinot noir work here, the pasture that separates one estate from the next, the way the ridge tilts north toward the bay.

If the **Red Hill Community Market** is on — first Saturday of the month, September to May — it is worth a detour. It is the best monthly market on the Peninsula and it is the one direct window you will get into how the producers here actually know each other. If the market is not on, keep driving.

## Stop 4 — Merricks General Wine Store (11:45)

Lunch stop. **Merricks General Wine Store** occupies the old village general store at Merricks and it is, by some distance, the most atmospheric low-friction lunch on the Peninsula. Not a hatted restaurant. Not a cellar-door degustation. A daylit dining room with paddock views, a short menu that leans on a wood oven, and wine from the Baillieu family estate out the back.

Order a pizza, a salad, a glass of the estate chardonnay. Sit for forty-five minutes. This is the meal that will tell you whether the Peninsula's version of country lunch suits you. If it does, everything else the region does at a higher price point will make sense. If it doesn't, you have saved yourself a lot of money on future bookings.

If Merricks is booked or closed, **Red Hill Brewery** is the honest substitute — the hop garden, the pizza oven, the tasting flight — and it tells you something slightly different about the Peninsula but gets you back on the road in the same amount of time.
...
A coffee in Mornington on the way through is not a bad last move if you are feeling sentimental about the day.

## The thing this drive teaches

The point of the orientation drive is not to pick a favourite stop. It is to understand that the Peninsula is not a single destination. It is four regions stacked on top of each other in a space you can cross in thirty minutes, and they each reward a different kind of weekend.

Most visitors go home from their first trip thinking they've done the Peninsula. What they have actually done is one version of it. This drive gives you all four in a single afternoon, so the next trip is not a first trip. It is a chosen one.
...
Whichever it is, you will already know where you are going. That is what the first day is for.
