...
dek: "Free vehicle and pedestrian entry. Fort Nepean on foot (~3km) or by the ticketed hop-on hop-off shuttle. 50+ heritage-listed buildings. Swimming at the Quarantine Station. Two all-terrain beach wheelchairs free to borrow. Dogs not permitted."
author: "editorial"
houseByline: true
...
faq:
  - question: "Is Point Nepean National Park free?"
    answer: "Yes. Vehicle and pedestrian entry is free — there is no entry gate fee. The internal hop-on hop-off shuttle to Fort Nepean is optional and ticketed - check current fares with Parks Victoria. Fort Nepean is approximately 3km on foot from Gunner's Cottage carpark, or you can cycle."
  ...
  - question: "How do you get to Fort Nepean?"
    answer: "Fort Nepean has no car access. Options: walk approximately 3km from Gunner's Cottage carpark (taking the main Defence Road track), cycle, or take the ticketed hop-on hop-off internal shuttle (adult, child and concession fares - check current prices with Parks Victoria). The shuttle has multiple stops along the way. Allow half a day if walking the full route — there is a lot to see."
...
The shuttle is ticketed, with adult return and child/concession return fares. Check current prices and operating hours at parks.vic.gov.au before visiting. The shuttle does not operate year-round at the same frequency.
