---
title: "The Sunset Drink: Where to Watch the Light Drop on the Peninsula"
dek: "The bay side goes gold at about five. The ocean side goes pink at about half past. You need a glass in your hand for both versions, and these are the seven places that understand the assignment."
author: "editorial"
houseByline: true
...
This is the most cinematic sunset drink on the Peninsula. It is also the most expensive. Know which one you want.
...
The pub itself is a proper village pub: well-kept rooms upstairs, a dining room that takes the food seriously without being precious about it, and a beer garden that works in every season. The sunset drink here is not the most photogenic on the Peninsula. It is the most honest.
...
## The smarter sunset move

Do not attempt a sunset drink at a restaurant where you also have a dinner booking. The sunset is the event. Dinner is a different event. Combining them means you rush one or miss the other.

Do not drive to the back beaches for a sunset drink. The ocean coast faces south and south-east. The sunset is behind you. It is beautiful, but it is not the drink.

Do not try to catch sunset from Arthur's Seat. The lookout faces east. The view is spectacular at sunrise. At sunset you are looking at the dark side of the sky. Go in the morning.
