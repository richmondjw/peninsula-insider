...
relatedArticles:
  ...
  - "best-wineries-red-hill"
  - "quealy-winemakers-balnarring"
  - "even-keel-polperro-wines"
  - "area-guide-main-ridge"
  - "area-guide-red-hill"
...
clusterLinks:
  ...
  - label: "Red Hill Area Guide"
    href: "/journal/area-guide-red-hill/"
...
[Dexter](/wine/dexter-wines/) has no signage and no restaurant. The tastings are strictly by appointment. What you get in exchange is the most private, most focused hour in [Main Ridge](/journal/area-guide-main-ridge/): Tod Dexter or one of his team pouring through a small, deliberately narrow range of pinot noir and chardonnay that has been refined over three decades. The wines are carefully structured and reward cellaring in a way that the bigger trophy estates often don't.
...
Mike Aylward grew up in Peninsula wine country. His family founded [Kooyong](/wine/kooyong/). When he decided to start his own label he built [Ocean Eight](/wine/ocean-eight/) deliberately smaller and more single-minded than any of the big names, and the cellar door reflects that. It is minimal, functional, and entirely focused on the wines.
...
- **10:00**  -  [Quealy Winemakers](/wine/quealy-winemakers/) for the welcome and the Italian varieties
- **11:30**  -  [Kooyong](/wine/kooyong/) for the single-vineyard flight
