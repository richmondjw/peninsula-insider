...
publicToilets: true
bestSeason: April to July (squid peak); November to March (whiting)
primarySpecies:
  - squid
  - king-george-whiting
  - snapper
...
faq:
  ...
  - question: How tide-dependent is Flinders Pier?
...
The reference station is Stony Point. Tides at Flinders lag Stony Point by a small margin. Use [BOM tidal predictions](http://www.bom.gov.au/australia/tides/) or [Willyweather](https://tides.willyweather.com.au) with the Stony Point predictions as the base.

Some sections of the pier are periodically closed for safety inspections and maintenance. Check current access via [Parks Victoria](https://www.parks.vic.gov.au/projects/melbourne-region/flinders-pier-project) before your visit. The walkway from shore to structure remains above water through the tidal cycle, so there are no access timing issues at the pier itself.
...
For Western Port charter departures targeting the same species: [Western Port Fishing Charters](/fishing/charters/western-port-fishing-charters/) operates from Hastings, the primary Western Port commercial charter base 25km north.
