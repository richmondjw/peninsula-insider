...
publicToilets: true
bestSeason: October to March (snapper); November to March (whiting); year-round (squid)
primarySpecies:
  - snapper
  - king-george-whiting
  - squid
tideStation: Stony Point
tideNotes: 'San Remo is at the entrance of Western Port; tidal current here is among the strongest at any Peninsula land-based location. Running tide is essential. Use heavy sinkers (60 to 100g) at peak run. Slack water produces noticeably less.'
safetyNotes: Strong tidal current at peak run. Do not wade or enter the water at any tidal state. Working channel with commercial vessel and ferry traffic; stay clear of the channel.
intro: 'San Remo Jetty fishes the entrance of Western Port, where the bay meets Bass Strait. Tidal current is the strongest of any Peninsula land-based location, which translates directly into productive sessions on the run and unproductive sessions at slack. Snapper through summer, whiting on the rising tide, squid year-round. The location requires the heaviest sinkers and the most precise tide planning of any pier in the Peninsula network.'
metaDescription: 'San Remo Jetty fishing — strongest tides on the Peninsula network, snapper, whiting, squid at the Western Port entrance. Heavy sinkers required.'
faq:
  - question: Why is San Remo''s tide stronger than other Peninsula locations?
    answer: 'San Remo sits at the narrow channel entrance to Western Port between San Remo and Newhaven. The full Western Port tidal exchange (approximately 2.5 to 2.8m range) flows through this constriction at every phase of the tide, producing current that is faster than at any wider section of the bay. The practical effect: heavier sinkers (60 to 100g and beyond at peak run), tighter timing of fishing windows around running phases, and the absolute necessity of avoiding slack water if you want fish.'
  - question: How does San Remo compare to Stony Point Pier?
...
The walkway to the jetty is at foreshore level and accessible at all tidal states. The jetty itself is an older structure; check the [Bass Coast Shire](https://www.basscoast.vic.gov.au/) for current condition notices before relying on outer sections.
...
- [Stony Point Pier](/fishing/locations/stony-point-pier/) for the comparable strong-current Western Port option.
- [Cowes Jetty](/fishing/locations/cowes-jetty/) is on the Phillip Island side of the same bay system.
