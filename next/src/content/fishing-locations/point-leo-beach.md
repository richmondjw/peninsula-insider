---
slug: point-leo-beach
name: Point Leo Beach
locationType: beach
...
publicToilets: true
bestSeason: April to August (winter salmon run); October to March (snapper opportunistic)
primarySpecies:
  - australian-salmon
  - snapper
  - gummy-shark
tideStation: Stony Point (Bass Strait fringe; Stony Point is the closest reference, expect lag)
...
faq:
  ...
  - question: What gear do I need for surf-cast fishing here?
    answer: 'Less heavy than Gunnamatta but still surf-rated. A 10 to 12 foot surf rod rated 5 to 8kg, a 5000 size fixed-spool reel, 20 to 30lb braid mainline, 30lb monofilament leader, metal slugs (20 to 60g) for salmon or ganged-hook pilchard rigs for bait. Closed-toe footwear and waterproof outer layer are not optional.'
  - question: When is Point Leo most productive?
    answer: 'Winter salmon run, June through August, is the most reliable productive window. Schools push along the south coast and work the Point Leo gutters during the winter migration. Outside that window, fishing is opportunistic; the beach can produce nothing on a still summer afternoon and produce well on a gentle swell when baitfish are present.'
status: published
verified: true
...
- [Gunnamatta Beach](/fishing/locations/gunnamatta-beach/) for the harder-exposure surf-cast option.
- [Australian salmon species page](/fishing/species/australian-salmon/) for technique and gear detail.
