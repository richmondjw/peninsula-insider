...
secondaryRegions:
  - western-port
bagLimit: 10 per person per day, combined total for squid, calamari, octopus and cuttlefish (outside restricted areas)
sizeLimit: No minimum legal size
peakSeason: March to June (autumn aggregation)
licenceRequired: true
seasonality:
  - {month: jan, portPhillipBay: fair, westernPort: rare, bassStraitFringe: rare}
  - {month: feb, portPhillipBay: fair, westernPort: rare, bassStraitFringe: rare}
  - {month: mar, portPhillipBay: peak, westernPort: fair, bassStraitFringe: fair}
  - {month: apr, portPhillipBay: peak, westernPort: good, bassStraitFringe: fair}
  - {month: may, portPhillipBay: peak, westernPort: good, bassStraitFringe: fair}
  - {month: jun, portPhillipBay: peak, westernPort: good, bassStraitFringe: fair}
  - {month: jul, portPhillipBay: good, westernPort: fair, bassStraitFringe: fair}
  - {month: aug, portPhillipBay: good, westernPort: fair, bassStraitFringe: fair}
  - {month: sep, portPhillipBay: good, westernPort: fair, bassStraitFringe: fair}
  - {month: oct, portPhillipBay: fair, westernPort: fair, bassStraitFringe: fair}
  - {month: nov, portPhillipBay: fair, westernPort: fair, bassStraitFringe: fair}
  - {month: dec, portPhillipBay: fair, westernPort: rare, bassStraitFringe: fair}
locationSlugs:
  - rye-pier
  - sorrento-pier
  - mornington-pier
...
faq:
  ...
  - question: What is the bag limit for squid in Victoria?
    answer: 'A combined total of 10 per person per day for squid, calamari, octopus and cuttlefish (outside restricted areas). There is no minimum legal size. Open year-round. Source: VFA. Confirm before fishing.'
  - question: What's the difference between squid and calamari?
    answer: '"Squid" and "calamari" are used interchangeably in conversation along the Peninsula. Technically, "calamari" is the more precise name for Sepioteuthis australis (southern calamari), the dominant species on Peninsula grounds. The VFA uses both terms. The bag limit is combined under the same category as octopus and cuttlefish.'
  - question: Do I need a fishing licence to catch squid?
    answer: 'Yes. A Victorian Recreational Fishing Licence is required to take squid from Victorian waters for anglers aged 18 and over. Children under 18 are exempt. Anglers fishing from a licensed charter vessel are generally covered by the operator''s licence; confirm at booking.'
  - question: What is the best squid jig size for Peninsula squid jigging?
    answer: 'A 2.5 size egi is the workhorse for autumn squid on the Peninsula. The size 2.0 to 3.0 range covers the Peninsula''s squid sizes. Carry a selection of colours (pink/orange, natural shrimp, chartreuse purple) and switch if the chosen colour is not producing within 20 minutes.'
status: published
verified: true
...
Consult [BOM tide predictions](http://www.bom.gov.au/australia/tides/) or [Willyweather](https://tides.willyweather.com.au) for the Portsea reference station when planning pier sessions.
...
- **Marine Protected Areas.** Fishing is restricted in certain marine sanctuary zones around the Mornington Peninsula National Park. Confirm [Parks Victoria](https://www.parks.vic.gov.au/places-to-see/parks/point-nepean-national-park) restrictions before fishing near Point Nepean.
