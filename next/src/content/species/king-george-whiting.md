...
commonName: King George Whiting
...
secondaryRegions:
  - western-port
bagLimit: 20 per person per day
sizeLimit: 27cm total length
peakSeason: January to April (Port Phillip Bay)
licenceRequired: true
seasonality:
  - {month: jan, portPhillipBay: peak, westernPort: good, bassStraitFringe: fair}
  - {month: feb, portPhillipBay: peak, westernPort: good, bassStraitFringe: fair}
  - {month: mar, portPhillipBay: peak, westernPort: good, bassStraitFringe: fair}
  - {month: apr, portPhillipBay: peak, westernPort: good, bassStraitFringe: rare}
  - {month: may, portPhillipBay: good, westernPort: good, bassStraitFringe: rare}
  - {month: jun, portPhillipBay: fair, westernPort: good, bassStraitFringe: rare}
  - {month: jul, portPhillipBay: fair, westernPort: good, bassStraitFringe: rare}
  - {month: aug, portPhillipBay: fair, westernPort: good, bassStraitFringe: rare}
  - {month: sep, portPhillipBay: fair, westernPort: good, bassStraitFringe: fair}
  - {month: oct, portPhillipBay: good, westernPort: good, bassStraitFringe: fair}
  - {month: nov, portPhillipBay: good, westernPort: good, bassStraitFringe: fair}
  - {month: dec, portPhillipBay: good, westernPort: good, bassStraitFringe: fair}
locationSlugs:
  - rye-pier
  - sorrento-pier
  - mornington-pier
...
intro: 'King George whiting is the Peninsula''s technically most-demanding table fish. The bag limit is generous, the eating quality is exceptional, and the catch rate is governed by a single rule: no run no fun. Whiting in flat, current-free water are effectively unfishable. Get the tide right and the rest follows.'
metaDescription: 'How to catch King George whiting on the Mornington Peninsula. VFA bag limit (20 per day), 27cm size limit, peak January to April, paternoster on bass yabbies, the no-run-no-fun rule explained.'
vfaCitationUrl: 'https://vfa.vic.gov.au/recreational-fishing/recreational-fishing-guide/catch-limits-and-closed-seasons/types-of-fish/marine-and-estuarine-scale-fish/king-george-whiting'
faq:
  - question: When is the best time to fish for King George whiting on the Peninsula?
  ...
  - question: What is the bag and size limit for King George whiting in Victoria?
    answer: 'Twenty per person per day. Minimum size is 27cm total length. Open year-round, no closed season. KGW cannot be filleted in or on Victorian waters; fish must be kept whole or in carcass form until away from the water. Source: VFA. Confirm before fishing.'
  - question: What is the no-run-no-fun rule?
    answer: 'Whiting are governed almost entirely by tidal current. In flat, current-free water they settle on the bottom and stop feeding actively. When the tide is running (ideally a rising tide with at least 0.5m of movement over two hours), the fish lift off the bottom and feed on the invertebrates the current stirs up. The rule is not a guideline; it is the governing principle of KGW fishing on Port Phillip Bay.'
  - question: What is the best bait for King George whiting?
  ...
  - question: Can I catch King George whiting on lures?
    answer: 'Possible but a niche approach on the Peninsula. Whiting are caught almost exclusively on bait rigs (paternoster with bass yabby or pipi). Soft plastics work occasionally for larger fish in shallow sand-flat conditions, but bait is the standard and the productive method.'
status: published
verified: true
...
**Western Port tides.** Western Port has a more complex tidal pattern than Port Phillip; it runs a double-high-water pattern on many days, creating two brief windows of tidal run. Consult the [BOM Stony Point tide predictions](http://www.bom.gov.au/australia/tides/) and [Willyweather](https://tides.willyweather.com.au) specifically for Western Port. Do not use Port Phillip predictions interchangeably.
...
- **Licence.** A [Victorian Recreational Fishing Licence](https://vfa.vic.gov.au/recreational-fishing/recreational-fishing-licence) is required for anglers aged 18 and over. Charter exemptions apply; confirm with the operator.

Source: [Victorian Fisheries Authority](https://vfa.vic.gov.au/recreational-fishing/recreational-fishing-guide/catch-limits-and-closed-seasons/types-of-fish/marine-and-estuarine-scale-fish/king-george-whiting). Last fact-verified Thu, 30 Apr 2026.

## Opportunity ranking by location

1. **[Rye Pier](/fishing/locations/rye-pier/), paternoster, pipis or bass yabby, January to April, rising tide.** The canonical land-based KGW location on Port Phillip Bay. Consistent results when the tide is running. Weekend crowds are significant; arrive before 0630 or target weekday sessions. The pier's 450m-plus length and the clean sandy bottom beyond the pier head provide the classic whiting habitat.
...
3. **[Sorrento Pier](/fishing/locations/sorrento-pier/), paternoster, pipis, November to April, mid-tide.** Reliable summer KGW from the pier with sheltered access and a nearby car park. The sand flat extending northeast from the pier head is the prime zone.
4. **Western Port (Hastings to Tooradin), boat drift, deep paternoster, May to September, moving tide.** When Port Phillip fish are in deep water or absent, Western Port's tidal run keeps whiting active in the deeper channels. Best from [Hastings Boat Ramp](/boating/ramps/hastings-boat-ramp/) on a day with two usable tide cycles.
