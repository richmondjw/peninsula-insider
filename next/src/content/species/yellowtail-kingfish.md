...
secondaryRegions:
  - port-phillip-bay
bagLimit: 2 per person per day (effective October 2025)
sizeLimit: 60cm total length
peakSeason: December to March (summer warm-current visitors)
licenceRequired: true
seasonality:
  - {month: jan, portPhillipBay: good, westernPort: fair, bassStraitFringe: peak}
  - {month: feb, portPhillipBay: good, westernPort: fair, bassStraitFringe: peak}
  - {month: mar, portPhillipBay: good, westernPort: fair, bassStraitFringe: peak}
  - {month: apr, portPhillipBay: fair, westernPort: rare, bassStraitFringe: good}
  - {month: may, portPhillipBay: fair, westernPort: rare, bassStraitFringe: fair}
  ...
  - {month: sep, portPhillipBay: rare, westernPort: rare, bassStraitFringe: rare}
  - {month: oct, portPhillipBay: rare, westernPort: rare, bassStraitFringe: fair}
  - {month: nov, portPhillipBay: fair, westernPort: rare, bassStraitFringe: good}
  - {month: dec, portPhillipBay: fair, westernPort: rare, bassStraitFringe: peak}
locationSlugs: []
charterSlugs:
  - proline-charters
eatLinks:
  - { label: "The seafood list (Peninsula Insider Journal)", href: "/journal/the-seafood-list/" }
intro: 'Yellowtail kingfish are the Peninsula''s pelagic summer visitor. Schools push down from warmer northern waters in December and January, hunting baitfish around the Heads, Cape Schanck, and offshore structures into Bass Strait. Hard-fighting trophy species, almost exclusively a boat fishery, bag limit halved to 2 per day in October 2025 to protect a recovering southern population.'
metaDescription: 'How to catch yellowtail kingfish on the Mornington Peninsula. VFA bag 2 per day (reduced from 5 in Oct 2025), 60cm size, summer Dec–Mar peak around the Heads and offshore structures. Boat fishery.'
vfaCitationUrl: 'https://vfa.vic.gov.au/recreational-fishing/recreational-fishing-guide/catch-limits-and-closed-seasons/types-of-fish/marine-and-estuarine-scale-fish/yellowtail-kingfish'
faq:
  - question: What is the bag and size limit for yellowtail kingfish in Victoria?
    answer: '2 per person per day (reduced from 5 effective October 2025 to protect a recovering southern population). Minimum size 60cm total length. Open year-round. The October 2025 bag limit reduction was confirmed by VFA and VRFish; this applies to all Victorian waters including Port Phillip Bay and Bass Strait. Source: VFA. Confirm before fishing.'
...
Source: [Victorian Fisheries Authority](https://vfa.vic.gov.au/recreational-fishing/recreational-fishing-guide/catch-limits-and-closed-seasons/types-of-fish/marine-and-estuarine-scale-fish/yellowtail-kingfish). Bag limit reduction confirmed by [VRFish](https://vrfish.com.au/2025/10/23/new-yellowtail-kingfish-bag-limits-in-effect/) October 2025. Last fact-verified Thu, 30 Apr 2026.
