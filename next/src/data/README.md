...
Places are the lowest-effort entity to create but the highest leverage  -  a single place file triggers an auto-generated hub page (`/explore/places/red-hill/`, etc.) that aggregates every venue tagged to that place.
